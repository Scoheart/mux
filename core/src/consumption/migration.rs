...
mod tests {
    use super::*;
    use crate::consumption::{commit_asset_operation, AssetCommitRequest, ConsumptionStatus};
    use crate::ops::{disable, install};
