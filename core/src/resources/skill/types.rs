pub use crate::domain::skill::{
    ManagedSkillRecord, RiskFinding, RiskLevel, SkillContentKind, SkillRiskSummary,
    SkillSettingsSnapshot, SkillSource, SkillUpdateState,
};
...
pub struct SkillsInventory {
    ...
    /// Every audited Skill writer, including Agents that are not currently
    /// installed. Workspace capability projection reuses this graph instead of
    /// probing the same targets a second time.
    #[serde(default)]
    pub capabilities: Vec<SkillAgentCapabilityView>,
